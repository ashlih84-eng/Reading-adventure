export type ActivityType='read-aloud'|'word-recognition'|'sequencing'|'main-idea'|'retelling'|'vocabulary'|'sentence-building'|'story-evidence'|'short-response';
export interface LessonActivity{id:string;type:ActivityType;prompt:string;options?:string[];answer?:number;acceptedText?:string[]}
